...
from utils import load_data, accuracy, graph_construct
...
# dataset params
parser.add_argument('--dataset', type=str, default='mnist', metavar='DATASET', help="cifar10, mini or tiered")
parser.add_argument('--n_label', type=int, default=1000, metavar='n_label', help="number of labeled data")
parser.add_argument('--data_root', default='/mnt/Code/data/mnist/', type=str, metavar='FILE', help='dir of image data')
