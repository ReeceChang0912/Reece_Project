...
def parse_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),'BiAAE-master','data'))
    ...
    parser.add_argument("--src_emb", type=str, default='/content/drive/My Drive/BiAAE-master/wiki.multi.en.vec')
    parser.add_argument("--tgt_lang", type=str, default='zh')
    parser.add_argument("--tgt_emb", type=str, default='/content/drive/My Drive/BiAAE-master/wiki.multi.de.vec')
    ...
    parser.add_argument("--iters_in_epoch", type=int, default=20)
...
def main():
    ...
    params.export_dir = "/content/drive/My Drive/BiAAE-master/export".format(params.exp_id,params.src_lang,params.tgt_lang,params.norm_embeddings)
    if params.dataset=='wiki':
        params.eval_file = './data/dictionaries/en-de.5000-6500.txt'.format(params.src_lang,params.tgt_lang)
    elif params.dataset=='wacky':
        params.eval_file = './data/dictionaries/en-de.test.txt'.format(params.src_lang,params.tgt_lang)
    else:
